...
let startGame = function(login){
	...
	Girl.prototype = {
		draw:function(){
			context.drawImage(image2, 0, 20, this.imgWidth, this.imgHeight, this.x, this.y = dpyHeight - 80, 150, 90);
		},
	...
	let gameLoop = function(){
		if(GAME_OVER){
			...
			divScore.style.height = "2em";
			divScore.style.width = "10em";
